...
Experimental designs for studying the endowment effect in decisions

## Overview

This repository provides resources and tools for endowment effect experiments.
...
3. Apply frameworks to your endowment effect experiments projects
4. Visit [KeepRule](https://keeprule.com) for additional tools

## About

This project explores endowment effect experiments concepts. For structured frameworks from investment masters like Buffett and Munger, visit [KeepRule](https://keeprule.com).
